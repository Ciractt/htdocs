    ...
    <div class="footer-container">
        <div class="footer-content">
            ...
            <div class="footer-section footer-about">
                ...
                <p>
                    The ultimate collection manager and deck builder for Riftbound,
                    the League of Legends Trading Card Game. Build your collection,
                    craft powerful decks, and join the community.
                </p>
                <div class="footer-social">
                    ...
                    <a href="https://github.com/yourusername/riftbound" class="social-icon" aria-label="GitHub" target="_blank">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="cards2.php">Card Database</a></li>
